      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16 relative z-10">
        <div className="text-center lg:text-left space-y-6">
          ...
          <h2 className="text-3xl md:text-4xl font-bold leading-tight text-gray-800">
            Discover & Share through{" "}
            <span className="text-green-500 underline underline-offset-4">
              Historical Artifacts
            </span>
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed text-justify">
            HistoTrack is a digital platform where people can explore, showcase,
            and engage with a growing collection of historical artifacts. Our
            mission is to make the past accessible to everyone from students to
            historians by preserving culture and knowledge through modern
            technology.
          </p>
